...
- **Receipt Scanning:** Users can take a photo of a Polish sales slip. The system uses a vision-capable LLM to perform OCR and extract items and quantities in a single step.
...
- **AI Tailoring:** The AI analyzes the recipe against the user's inventory to suggest specific ingredient substitutions. It does _not_ rewrite cooking instructions.
...
- AI provides specific substitution advice based _only_ on available inventory (e.g., "Use Greek Yogurt instead of Sour Cream").
